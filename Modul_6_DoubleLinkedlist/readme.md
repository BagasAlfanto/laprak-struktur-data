...
Doubly Linked List adalah pengembangan dari Single Linked List di mana tiap node memiliki dua penunjuk (prev dan next) sehingga memungkinkan penelusuran dari depan maupun belakang; menurut penelitian, struktur ini memudahkan penyisipan dan penghapusan di tengah tanpa harus menelusuri dari awal, banyak dipakai untuk sistem dengan navigasi dua arah (mis. undo/redo atau pengelolaan data), namun membutuhkan memori lebih dan pengelolaan yang lebih kompleks dibandingkan Single Linked List.
...
> ![Screenshot guided 1](output/Screenshot_Guided_1.png)
>
> ![Screenshot guided 2](output/Screenshot_Guided_2.png)
>
> ![Screenshot guided 3](output/Screenshot_Guided_3.png)

Program ini menggunakan struktur doubly linked list untuk menyimpan dan mengelola data. Melalui menu interaktif pengguna dapat menambah, menghapus, menampilkan, atau memperbarui elemen. Setiap elemen berada dalam node yang terhubung dua arah (prev/next). Saat menambah, program membuat node baru dan menempatkannya di depan, di belakang, atau setelah node tertentu; saat menghapus, program mencari node target lalu memutus dan menata ulang tautan antar node agar daftar tetap konsisten. Opsi tampil depan dan tampil belakang menampilkan isi list dari kedua arah, sedangkan fitur update mengganti nilai lama dengan nilai baru. Program berjalan terus hingga pengguna memilih keluar.
...
Program di atas merupakan implementasi struktur data Doubly Linked List untuk mengelola data kendaraan. Program terdiri dari tiga file: doublylist.h yang berisi deklarasi struktur data dan fungsi, doublylist.cpp yang mengimplementasikan operasi-operasi dasar seperti menambah, menampilkan, mencari, dan menghapus data kendaraan, serta main.cpp sebagai program utama yang berinteraksi dengan pengguna. Pengguna dapat memasukkan sejumlah data kendaraan yang terdiri dari nomor polisi, warna, dan tahun. Program memastikan tidak ada nomor polisi yang duplikat, menampilkan seluruh data kendaraan, memungkinkan pencarian kendaraan berdasarkan nomor polisi, serta mendukung penghapusan data kendaraan dari awal, akhir, atau tengah daftar. Struktur doubly linked list memungkinkan navigasi data ke dua arah, memudahkan proses manipulasi node dalam daftar.
